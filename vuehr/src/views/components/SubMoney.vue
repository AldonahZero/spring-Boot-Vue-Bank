<template>
  <div>
    <el-button type="text" @click="dialogFormVisible = true">取款</el-button>

    <el-dialog title="取款" :visible.sync="dialogFormVisible">
      <el-form :model="form">
...
export default {
  ...
  methods: {
    submitLogin() {
      this.putRequest("/user/withdrawals", this.form).then(resp => {
        if (resp) {
          console.log(resp);
